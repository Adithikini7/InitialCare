                            ...
                            while ($row3 = $stmt3->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td >
                                       ...
                                       //die($row4['tr_name']);
                                        if (isset($row4['tr_name']) != false) { ?>
                                            <h6 class="text-dark"><?php echo $row4['tr_name'] ?></h6>
                                       <?php } else if ($row3['book_status'] == 'rejected' || $row3['book_status'] == 'pending'and isset($row4['tr_name']) != false) { ?>
                                            <h6 class="text-light">--------</h6>
                                       <?php } else if (isset($row4['tr_name']) == false) { ?>
                                            <h6 class="text-dark">Not assigned</h6>
                                       <?php }?>
                                    </td>
                                    <td>
                                        <?php
